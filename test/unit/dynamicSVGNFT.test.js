    ...
    : describe("Dynamic SVG NFT Unit Tests", function () {
          ...
          describe("constructor", () => {
              it("sets starting values correctly", async function () {
                  const lowSVG = await dynamicSvgNft.i_lowPriceImageURI()
                  const highSVG = await dynamicSvgNft.i_highPriceImageURI()
                  const priceFeed = await dynamicSvgNft.i_priceFeed()
